...
//        }
        ...
        while (soE<=5) {
            ...
            soE ++; // soE++ -> tăng 1 đơn vị, -- thì là giảm 1 đơn vị --> hậu tố

            // vòng lặp do .. while
            // cú pháp: do { thực hiện logic}; while {điều kiện đúng}
            // logic là sẽ luôn thực hiện ít nhất 1 lần dù điều kiện có đúng hay không
            ...
            // dùng khi biết được số lần lặp lại cụ thế
